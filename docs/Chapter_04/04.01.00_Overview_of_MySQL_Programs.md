...
</td> </tr> <tr> <td> MYSQL_TCP_PORT </td> <td> 默认端口号；用于TCP/IP连接 </td> </tr> <tr> <td> MYSQL_PWD
</td> <td> 默认的密码 </td> </tr> <tr> <td> MYSQL_DEBUG
</td> <td> 当调试时调试跟踪选项 </td> </tr> <tr> <td> TMPDIR
</td> <td> 临时表和文件被创建时的目录 </td> </tr>
</ tbody></ table>
