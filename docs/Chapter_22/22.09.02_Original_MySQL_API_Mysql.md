...
<table summary="ext/mysql compile time support matrix" border="0">
    <thead>
        <tr>
            ...
            <th scope="col">
                Configure Options:
                <a class="link" href="apis-php-mysqlnd.overview.html" title="22.9.5.1.&nbsp;Overview">
                    mysqlnd
                </a>
            </th>
            <th scope="col">
...
<table summary="MySQL client constants" border="0">
    ...
    <tbody>
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-client-compress">
                </a>
                <code class="constant">
        ...
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-client-ignore-space">
                </a>
                <code class="constant">
        ...
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-client-interactive">
                </a>
                <code class="constant">
        ...
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-client-ssl">
                </a>
                <code class="constant">
                    MYSQL_CLIENT_SSL
                </code>
...
<table summary="MySQL fetch constants" border="0">
    ...
    <tbody>
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-assoc">
                </a>
                <code class="constant">
                    MYSQL_ASSOC
                </code>
        ...
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-both">
                </a>
                <code class="constant">
                    MYSQL_BOTH
                </code>
        ...
        <tr>
            <td scope="row">
                <a name="apis-php-constant.mysql-num">
                </a>
                <code class="constant">
                    MYSQL_NUM
                </code>
