...
有一些杂项表没有划分先前的任何组中。例如, performance\_timers列出可用的事件计时器和他们的特点，对于计时器的信息，参照[Section 21.2.3.1, “Performance Schema Event Timing”](./21.2.3_Performance_Schema_Runtime_Configuration.md) 
